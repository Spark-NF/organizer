...
SymbolicLinkAction::SymbolicLinkAction(const TemplateString &destination, bool create, bool overwrite)
...
QList<std::pair<QString, QStringList>> SymbolicLinkAction::requiredKeys() const
{
